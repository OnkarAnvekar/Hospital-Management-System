    ...
    <div>
      ...
      <div class="d-flex justify-content-between container-fluid">
        <div class="p-1 bd-highlight">
          <Button onClick={ToggleEditPatientModal} variant="primary">
            Edit Patient
          </Button>
        </div>
        {/* ==========================remove patient==================================== */}
      ...
      <table class="table table-hover receptionPatientTable"
          style={{marginTop:"10px",borderRadius:"10px",backgroundColor:"rgb(147, 199, 201)",fontSize:"larger"}}
      >
        <tbody>
          <tr>
            <th>Name:</th>{" "}
          ...
          <tr>
            ...
            <th>
              {patientDetails.paymentStatus == "paid" ? (
                ...
                <Button variant="warning">{patientDetails.paymentStatus}</Button>
              )}
            </th>
          </tr>
        </tbody>
