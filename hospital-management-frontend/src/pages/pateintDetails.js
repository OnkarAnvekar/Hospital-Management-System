...
const PatientDetails = () => {
  ...
  const renderTooltip = (props) => (
    <Tooltip id="button-tooltip" {...props}>
      <div style={{ color: "white" }}>contact no: {patientData.cellNo},</div>
      <div style={{ color: "white" }}>address:{patientData.address}</div>
    </Tooltip>
  );
  const PaymentStatus = () => {
    if (patientData.paymentStaus == "paid") {
      ...
      return (
        <div
          ...
          style={{ color: "warning", padding: "5px" }}
        >
          pending
        </div>
      );
  ...
  return (
    <div className="container-fluid mainContainer ">
      ...
      <div>
        ...
        >
          <Button style={{ marginTop: "30px" , fontSize:"larger" }} variant="secondary">
            {" "}
            <h4 className="title">
      ...
      style={{backgroundColor:"rgb(147, 199, 201)" , borderRadius:"20px" , fontSize:"larger"}}
      >
        <tbody>
          <tr>
            <th>Name:</th>{" "}
          ...
          <tr>
            ...
            <th>
              ...
              style={{backgroundColor:"rgb(147, 199, 201)"}}>
                <tr >
                  <th>medicine</th>
                  <th>No of tablets</th>
                  <th>prescription</th>
