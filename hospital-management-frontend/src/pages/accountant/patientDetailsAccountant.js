    ...
    <div className="patientDetailsAccountant">
      <div class="d-flex justify-content-between container-fluid">
        ...
        { paymentStatus=="paid"? <div class="p-2 bd-highlight">
          <Button variant="success" style={{color:"white",fontWeight:"bold"}} >
            {patientDetails.paymentStatus}
          </Button>
        </div> :<div class="p-2 bd-highlight">
          <Button variant="danger" style={{color:"white",fontWeight:"bold"}} >
            {patientDetails.paymentStatus}
          </Button>
        </div>}
      ...
      <table
        ...
        style={{ backgroundColor: "rgb(147, 199, 201)" , fontSize:"large" }}
      >
        <tbody>
          <tr>
            <th>Name:</th>{" "}
      ...
      >
        ...
        <tr>
          ...
          <td style={{backgroundColor:"antiquewhite ",fontWeight:"bold" ,fontSize:"larger"}}>
            Rs.
